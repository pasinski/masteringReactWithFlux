...
var AutoCompleter = function (_Component) {
	...
	_createClass(AutoCompleter, [{
		...
		value: function render() {
			...
			return _react2['default'].createElement('div', { className: classes.root, style: styles.root, ref: 'autocompleter-root', onKeyDown: keyboard && this.handleKeyEvent }, _react2['default'].createElement(_Input2['default'], { value: inputValue, placeholder: placeholder, className: classes.input, styles: styles.input, props: inputProps, onChange: this.handleInputChange, onBlur: this.onBlur, onFocus: this.onFocus }), _react2['default'].createElement(_ListContainer2['default'], { data: filteredItemList, onSelect: this.onSelect, className: classes.listContainer, itemClassName: classes.listItems, styles: styles.listContainer, itemStyles: styles.listItems, navigate: navigate - 1 }));
		}
	}], [{
		key: 'displayName',
		value: 'AutoCompleter',
...
//# sourceMappingURL=AutoCompleter-compiled.js.map